...
public class MagazynBazaDanych extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        String sqlString = "CREATE TABLE " + NAZWA_TABELI
                + "(_id INTEGER PRIMARY KEY AUTOINCREMENT, "
                + NAZWA_KOLUMNY_1 + " TEXT, "
                + NAZWA_KOLUMNY_2 + " INTEGER)";
    ...
    public Integer podajIlosc(String wybraneWarzywo) {
        ...
        try {
            ...
            kursor = bazaDoOdczytu.query(MagazynBazaDanych.NAZWA_TABELI,
                    new String[] {MagazynBazaDanych.NAZWA_KOLUMNY_2},
                    MagazynBazaDanych.NAZWA_KOLUMNY_1 + "=?",
                    new String[] {wybraneWarzywo},
                    null, null, null);
